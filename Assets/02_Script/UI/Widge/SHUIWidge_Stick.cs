...
public class SHUIWidge_Stick : SHMonoWrapper
{
    public enum eState
    {
        Idle,       // 대기상태
    ...
    {
        SHGameObject.SetParent(gameObject, ((SHUIWidge_Monster)pArgs[0]).gameObject);
    }
    ...
    void SetCrash(SHUIWidge_Monster pMonster)
    {
        if (null == pMonster)
            return;
